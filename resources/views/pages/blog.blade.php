        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title-heading">
                    ...
                    <p class="mx-auto my-3 col-lg-6 col-md-6 col-sm-12 text-center">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                        ...
                        <div class="col-lg-10 col-md-7 col-sm-12 col-xs-12 my-3">
                            <div class="row mx-0 article">
                                ...
                                <div class="blog-text col-lg-6">
                                    ...
                                    <a href="#" class="btn-blog">{{ __('content.readFull')}}</a>
                                </div>
                                <div class="col-lg-2">
